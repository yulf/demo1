...
public class ContinuousCaptureActivity extends Activity implements SurfaceHolder.Callback,
    ...
    public static final String TAG = "ContinuousCaptureActivity";

    private static final int VIDEO_WIDTH = 320;  // dimensions for 720p video
    private static final int VIDEO_HEIGHT = 240;
    private static final int DESIRED_PREVIEW_FPS = 6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOutputFile = new File("/sdcard/", "continuous-capture.mp4");
